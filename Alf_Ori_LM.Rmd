...
ggplot() + geom_line(aes(x=Ymd,y=Yhat,col="Predicted")) + 
  geom_line(data=A,aes(x=Ymd,y=MA,col="Visual")) +
  labs(title=" Betelgeuse (Alf Orion) Magnitude Predctions",subtitle="Jan 1,2014- Nov. 12, 2022") + ylab("Visual Magnitude") +
  scale_y_reverse()
```
```{r}
